      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 mb-20">
          {[
            ...
            <div
              key={title}
              className="border border-[#D4E2DE] bg-[#F4F7F6]/60 rounded-3xl p-10 hover:shadow-lg transition-shadow"
            >
        ...
        <div className="bg-[#F4F7F6] border-l-4 border-[#E8960F] px-10 py-10 rounded-r-2xl mb-14">
